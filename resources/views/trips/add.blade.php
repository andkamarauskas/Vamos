                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('trips.post') }}">
                        ...
                        <div class="form-group{{ $errors->has('departure_address') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="departure_address" type="text" class="form-control" name="departure_address" value="{{ old('departure_address') }}" required autofocus >
                        ...
                        <div class="form-group{{ $errors->has('arrival_address') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="arrival_address" type="text" class="form-control" name="arrival_address" value="{{ old('arrival_address') }}" required autofocus >
                        ...
                        <div class="form-group{{ $errors->has('departure_time') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="timeformatExample1" type="text" class="form-control" name="departure_time" value="{{ old('departure_time') }}" required autofocus>
